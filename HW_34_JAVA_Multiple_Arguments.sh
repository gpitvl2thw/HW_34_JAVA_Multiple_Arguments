...
if [ $# -lt 8 ]; then echo "Should be 8 arguments"; return; fi
...
java -jar ./target/$REPO_NAME-$APP_VERSION-jar-with-dependencies.jar $ARGS_01 $ARGS_02 $ARGS_03 $ARGS_04 >> ../$REPO_NAME.txt
